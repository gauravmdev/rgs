...
export default function CustomerDetail() {
    ...
    const fetchCustomerDetails = async () => {
        try {
            ...
            // Security check: Ensure manager only views their own store's customers
            if (user?.storeId && response.data.customer.storeId !== user.storeId) {
                toast.error('You do not have permission to view this customer');
                navigate('/customers');
                return;
            }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                {currentDues > 0 && (
                    <Button onClick={() => setIsClearDuesModalOpen(true)} variant="secondary" className="bg-green-600 text-white hover:bg-green-700">
            ...
            <div className="card">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-900 font-medium">{formatDateTime(customer.createdAt)}</p>
                    </div>
                </div>
                                ...
                                {dueClearances.map((clearance) => (
                                    <tr key={clearance.id}>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {formatDateTime(clearance.clearedDate)}
                                        </td>
            ...
            >
                <form onSubmit={handleClearDues} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        <Button type="submit" className="bg-green-600 text-white hover:bg-green-700" loading={submitting}>
                            Record Payment
                        </Button>
                    </div>
                </form>
