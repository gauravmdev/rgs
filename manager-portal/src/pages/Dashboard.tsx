        ...
        <div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                            <Store size={20} className="text-primary-100" />
                            <p className="text-primary-100 text-lg">Managing: {user?.storeName || 'Store'}</p>
                        </div>
                    </div>
                    <div className="text-right">
                        <p className="text-sm text-primary-100">Store Manager</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <button
                    ...
                    className="card hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-primary-50 to-primary-100 border-2 border-primary-200"
                >
                    <div className="flex items-center justify-center mb-3">
                        <Plus size={32} className="text-primary-600" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 text-center">Create Order</h3>
                    <p className="text-sm text-gray-600 text-center mt-1">Process new order</p>
                </button>
                ...
                >
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center">Add Customer</h3>
                    <p className="text-sm text-gray-600 text-center mt-1">Manage customers</p>
                </button>
                ...
                >
                    ...
                    <h3 className="text-lg font-bold text-gray-900 text-center">View Analytics</h3>
                    <p className="text-sm text-gray-600 text-center mt-1">Sales reports</p>
                </button>
            </div>
